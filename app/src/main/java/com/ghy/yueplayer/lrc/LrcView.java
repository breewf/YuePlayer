...
public class LrcView extends View implements ILrcView{
	...
	/**高亮歌词的默认字体大小***/
	private static final float DEFAULT_SIZE_FOR_HIGHT_LIGHT_LRC = 60;
	/**高亮歌词当前的字体大小***/
	...
	/***时间线的颜色**/
	private static final int COLOR_FOR_TIME_LINE = 0xffEE4000;
	/**时间文字大小**/
	private static final int SIZE_FOR_TIME = 50;
	/**是否画时间线**/
