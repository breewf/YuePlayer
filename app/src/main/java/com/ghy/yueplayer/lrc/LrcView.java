...
public class LrcView extends View implements ILrcView {
     ...
     * 默认文字的字体大小
     **/
    private static float SIZE_FOR_DEFAULT_TEXT = 60;
     ...
     * 高亮歌词的默认字体大小
     ***/
    private static float DEFAULT_SIZE_FOR_HIGHT_LIGHT_LRC = 60;
    /**
     * 高亮歌词当前的字体大小
     ***/
     ...
     * 其他歌词的默认字体大小
     ***/
    private static float DEFAULT_SIZE_FOR_OTHER_LRC = 50;
    /**
     * 其他歌词当前的字体大小
     ***/
     ...
     * 时间文字大小
     **/
    private static int SIZE_FOR_TIME = 50;
    /**
     * 是否画时间线
     **/
     ...
     * 歌词间默认的行距
     **/
    private static float DEFAULT_PADDING = 40;
    /**
     * 歌词当前的行距
     **/
    ...
    @Override
    public void init() {
        SIZE_FOR_DEFAULT_TEXT = AppUtils.dip2px(getContext(), 16);
        DEFAULT_SIZE_FOR_HIGHT_LIGHT_LRC = AppUtils.dip2px(getContext(), 16);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = minRaw; i <= maxRaw; i++) {
            ...
            if (i == mCurRow) {//画高亮歌词
                ...
                mPaintForOtherLrc.setColor(0x1000000 * curAlpha + 0xc0c0c0);
