 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DrkMode-ConstraintLayout
 */
public class DnConstraintLayout extends BaseConstraintLayout implements IDarkMode {
    ...
    public DnConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
