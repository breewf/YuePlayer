 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DrkMode-LinearLayout
 */
public class DnLinearLayout extends BaseLinearLayout implements IDarkMode {
    ...
    public DnLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
