...
/**
 * Created on 2019-07-29 09:43
 *
 * @author andy
 */
public class DnCoordinatorLayout extends BaseCoordinatorLayout implements IDarkMode {
    ...
    public DnCoordinatorLayout(Context context) {
        this(context, null);
    }

    public DnCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DnCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
