 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DrkMode-FrameLayout
 */
public class DnFrameLayout extends BaseFrameLayout implements IDarkMode {
    ...
    public DnFrameLayout(Context context) {
        super(context);
        init(context, null);
    }

    public DnFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
