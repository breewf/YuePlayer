 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DarkMode-EditText
 */
public class DnEditText extends BaseEditText implements IDarkMode {
    ...
    public DnEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnEditText(Context context, AttributeSet attrs, int defStyleAttr) {
