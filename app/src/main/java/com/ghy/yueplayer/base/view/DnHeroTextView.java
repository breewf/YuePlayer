 ...
 */
public class DnHeroTextView extends BaseHeroTextView implements IDarkMode {
    ...
    public DnHeroTextView(Context context) {
        super(context);
        init(context, null);
    }

    public DnHeroTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnHeroTextView(Context context, AttributeSet attrs, int defStyleAttr) {
