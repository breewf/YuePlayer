 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DrkMode-RecyclerView
 */
public class DnRecyclerView extends BaseRecyclerView implements IDarkMode {
    ...
    public DnRecyclerView(Context context) {
        super(context);
        init(context, null);
    }

    public DnRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
