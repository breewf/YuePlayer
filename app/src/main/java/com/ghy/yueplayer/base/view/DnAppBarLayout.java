 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DarkMode-AppBarLayout
 */
public class DnAppBarLayout extends BaseAppBarLayout implements IDarkMode {
    ...
    public DnAppBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
