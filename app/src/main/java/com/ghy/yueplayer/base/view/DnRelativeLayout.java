 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DrkMode-RelativeLayout
 */
public class DnRelativeLayout extends BaseRelativeLayout implements IDarkMode {
    ...
    public DnRelativeLayout(Context context) {
        super(context);
        init(context, null);
    }

    public DnRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
