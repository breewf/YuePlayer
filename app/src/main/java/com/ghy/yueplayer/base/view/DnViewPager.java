 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DarkMode-ViewPager
 */
public class DnViewPager extends BaseViewPager implements IDarkMode {
    ...
    public DnViewPager(Context context) {
        super(context);
        init(context, null);
    }

    public DnViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
