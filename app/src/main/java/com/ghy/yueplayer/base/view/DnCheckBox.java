 ...
 * @author HY
 * @date 2019-07-23
 * Desc:DarkMode-CheckBox
 */
public class DnCheckBox extends BaseCheckBox implements IDarkMode {
    ...
    public DnCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DnCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
